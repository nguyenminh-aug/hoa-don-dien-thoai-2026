...
export function StatisticsPage() {
  const { invoices, payments: receipts } = useInvoices(); const { customers } = useCustomers(); const { expenses } = useOperatingExpenses(); const { debts } = useCustomerDebts(); const { payments: supplierPayments, investment } = useSupplierPayments()

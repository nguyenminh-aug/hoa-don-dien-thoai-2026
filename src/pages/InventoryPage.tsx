...
export function InventoryPage() {
  ...
  const inventory = useMemo(() => products.map(product => ({ ...product, quantity: Math.max(0, product.quantityAdjustment), value: Math.max(0, product.quantityAdjustment) * product.unitPrice })).sort((a, b) => a.productName.localeCompare(b.productName)), [products])
